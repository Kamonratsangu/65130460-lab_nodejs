...
const fullname = "65130460, Kamonrat Sanguanmoo";
//  data
const products = [
  {
    id: "1",
  ...
  {
    id: "6",
    name: "ADIDAS X Marimekko Yoga",
    category: "Adidas",
    price: 1320,
    cover:
      "https://static-ssp.supersports.co.th/media/overlay/overlay-1676861408.png?impolicy=resize&width=553",
  },
  {
    id: "7",
    name: "Nylon Ruched Mini Bag - Lilac",
    category: "Charleskeith",
    price: 1270,
    cover:
      "https://www.charleskeith.co.th/dw/image/v2/BCWJ_PRD/on/demandware.static/-/Sites-th-products/default/dw0721f2cc/images/hi-res/2022-L6-SL6-80151169-49-1.jpg?sw=1152&sh=1536",
  },
];
